...
- Help you choose the next Findable Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use Findable MCP, saved project context, web search, browser review, or local files.
...
- "What does Findable help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [Findable MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.
