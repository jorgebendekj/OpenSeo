...
description: "Interview once and save your site's goals, positioning, competitors, and key pages to your Findable project context."
---
...
Your agent asks about the website, goals, positioning, competitors, and key pages once, then saves the answers to your project's context in Findable.
...
- Confirm the right Findable project and read what is already saved.
...
- Recommend the next Findable Agent Skill to run.
...
## Use it with Findable MCP

Set up [Findable MCP](/docs/mcp) so your agent can read and write project context and use live SEO data in later workflows. The two context tools are free.
