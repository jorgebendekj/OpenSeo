...
- Ask before saving keywords back to Findable.
...
- Confirm before saving selected keywords to Findable.

## Use it with Findable MCP

Set up [Findable MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.
