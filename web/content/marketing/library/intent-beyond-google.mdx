...
![Findable keyword research results with the intent column labelling each keyword informational, navigational, commercial or transactional](/library/keyword-research/intent-by-surface-findable.png)
...
```text
Using the Findable MCP, research keywords for "[my topic]" and label
