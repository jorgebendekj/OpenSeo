...
const BETA_NOTICE_DISMISSED_KEY = "ada-beta-notice-dismissed";
  ...
  return (
    <div className="mx-2 mb-2 rounded-lg border border-base-300 bg-base-100 p-3">
      ...
      <p className="mt-1.5 text-xs text-base-content/70">
        For more powerful AI workflows, use the {BRAND.mcpServerName} with your own agent
...
export function AdaSidebarPanel({
  projectId,
  onNavigate,
}: {
  projectId: string;
...
export const SamSidebarPanel = AdaSidebarPanel;
