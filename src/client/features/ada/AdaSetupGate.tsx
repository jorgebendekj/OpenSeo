        ...
        <div className="flex items-start gap-3">
          ...
          <div className="max-w-3xl space-y-1.5">
            ...
            <div className="text-sm text-base-content/68">
              {BRAND.agentName}, {BRAND.name}'s in-app AI intelligence agent, needs an OpenRouter API key.
              Create a key on OpenRouter, set it as the{" "}
              <code>OPENROUTER_API_KEY</code> environment variable, restart
              {BRAND.name}, then confirm here.
            </div>
...
export const SamSetupGate = AdaSetupGate;
