...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use ${BRAND.name}`,
    `Research my competitors top pages and keywords and tell me what's working. Use ${BRAND.name}`,
  ];
}
        ...
        {connected ? (
          ...
          <>
            <div className="space-y-2 text-sm text-base-content/70">
              <p>
                {BRAND.name} is designed to give your AI agent the data it needs to
                build a great SEO and AI visibility strategy and help you execute it.
              </p>
              <p>
